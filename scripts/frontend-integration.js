 ...
 * This file demonstrates how to integrate Ipfsstore with a web frontend
 */

// For React/Vue/Angular applications
export class IpfsstoreClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new IpfsstoreClient(provider, contractAddress);
